  ...
  return (
    <section id="home" className="min-h-[80vh] flex flex-col justify-center items-start pt-20 relative">
      ...
      >
        ...
        <motion.h1 variants={item} className="text-4xl md:text-6xl font-extrabold mb-4 tracking-tight text-zinc-100">
          Karan Veer Singh
        </motion.h1>
        ...
        <motion.div variants={item} className="max-w-2xl text-zinc-400 text-base md:text-lg mb-8 leading-relaxed space-y-4">
          ...
          <div className="flex items-center gap-2 text-accentLight font-mono mt-2 bg-accent/10 w-max px-3 py-1 rounded-md border border-accent/20">
        ...
        <motion.div variants={item} className="flex flex-col sm:flex-row gap-4 mb-10 font-mono text-sm">
          <motion.div 
            ...
            className="flex items-center gap-3 px-5 py-3 bg-accent/10 border border-accent/40 rounded-md shadow-[0_0_15px_rgba(167,139,250,0.2)]"
          >
          ...
          <motion.div 
            whileHover={{ scale: 1.05, rotate: 2 }}
            className="flex items-center gap-3 px-5 py-3 bg-slate-800 border border-slate-700 rounded-md"
          >
        ...
        <motion.div variants={item} className="flex flex-wrap gap-4 font-mono text-sm">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            href="#projects"
            className="flex items-center gap-2 px-6 py-3 bg-accent text-darkBg hover:bg-accentLight transition-all rounded-sm font-bold shadow-[0_0_15px_rgba(167,139,250,0.4)]"
          >
            <Crosshair size={18} />
            VIEW_OPERATIONS
          </motion.a>
